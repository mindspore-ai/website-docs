...
$(document).ready(function () {
    ...
    ? p_name.split('/').slice(3)[0]
    :p_name.split('/').slice(4)[0];
    ...
    if(pathname.indexOf('/doc/api_python/') !== -1) {
        ...
        $('.wy-grid-for-nav #rtd-search-form input').eq(0).attr('placeholder', '"API" 内搜索');
    }
   ...
   for(let i=0;i<doms.length;i++){
    ...
    if(pathname.indexOf('/doc/api_python/zh-CN/r1.2/index.html') !== -1) {
